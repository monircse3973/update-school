      ...
      <section class="section-padding wow fadeInUp service_bg">
          <div class="container">
            <div class="row">
              <div class="col-md-5 offset-md-3">
                <h2 class="Service_area">Clients List :</h2>
              </div>
            </div>
          ...
          <div class="row">
             <div class="col-md-4 offset-md-2">
                ...
                <li>1. Jui Enterprise</li>  
                  <li> 2. Ahmed zaker:</li>
                  <li> 3.  Eastfield </li>
                   <li> 4. Porosmoni School and college</li>
                </ul>  
             </div>
             <div class="col-md-6">
              <ul>
                 <li> 5. Kalagachia Rf High School</li>
                   <li>6. Darbar Travels</li>
                   <li> 7. Little jewels </li>
                   <li>8. Moghbazar High School</li>
              </ul>
